...
[GitHub issue tracker]: https://github.com/eHealthAfrica/sense-ebola-followup/search?type=Issues
[reduced test case]: http://css-tricks.com/reduced-test-cases
[new issue]: https://github.com/eHealthAfrica/sense-ebola-followup/issues/new
...
1. Clone and fork the project
    ...
    ```bash
    git clone eHealthAfrica/sense-ebola-followup
...
[the repo]: https://github.com/eHealthAfrica/sense-ebola-followup
